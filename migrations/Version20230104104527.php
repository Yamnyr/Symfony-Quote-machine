 ...
 */
final class Version20230104104527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quote (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, author_id INT NOT NULL, content VARCHAR(255) NOT NULL, meta VARCHAR(255) NOT NULL, INDEX IDX_6B71CBF412469DE2 (category_id), INDEX IDX_6B71CBF4F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
